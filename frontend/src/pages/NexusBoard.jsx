    ...
    <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 min-h-[calc(100vh-4rem)]">
          ...
          {feedTab === 'explore' && (
            <div className="flex flex-wrap items-center gap-2">
              ...
              <select
                ...
                className="input-premium py-2 px-3 rounded-xl text-sm min-w-[12rem] bg-background border border-white/10"
              >
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0 sm:pt-1">
            {inSpecificRoom && (
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                transition={spring}
                className="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm font-semibold border border-primary/35 bg-primary/10 text-primary shadow-[0_0_24px_rgba(14,165,233,0.15)] hover:bg-primary/15"
              >
            ...
            {showCreateButton && (
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                transition={spring}
                className="inline-flex items-center justify-center gap-2 btn-gradient rounded-xl px-6 py-3.5 text-sm font-semibold shadow-lg shadow-primary/25"
              >
          ...
          {mascotOpen && inSpecificRoom && (
            <>
              ...
              <motion.div
                ...
                transition={spring}
                className="fixed z-50 bottom-6 left-4 right-4 sm:left-auto sm:right-6 sm:w-[min(100vw-3rem,22rem)] glass-float border border-white/10 rounded-2xl shadow-2xl shadow-black/50 flex flex-col max-h-[min(70vh,28rem)] overflow-hidden"
              >
                <div className="flex items-center justify-between gap-2 px-4 py-3 border-b border-white/10 bg-black/35">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.94 }}
                    className="p-2 rounded-xl text-text-muted hover:text-text hover:bg-white/5 shrink-0"
                  >
                ...
                <form
                  ...
                  className="flex gap-2 p-3 border-t border-white/10 bg-black/40 backdrop-blur-md"
                >
                  <input
                    type="text"
                    value={mascotInput}
                    ...
                    className="flex-1 input-premium py-2.5 px-3 rounded-xl text-sm"
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-10 h-10 rounded-xl btn-ai-primary flex items-center justify-center disabled:opacity-40 shrink-0 border-0 p-0"
                  >
      ...
      <aside className="w-full lg:w-[17.5rem] xl:w-72 shrink-0">
        <div className="lg:sticky lg:top-4 max-h-none lg:max-h-[calc(100vh-5rem)] flex flex-col gap-3">
          <div className="rounded-2xl p-[1px] bg-gradient-to-b from-white/[0.14] via-white/[0.06] to-transparent shadow-[0_12px_48px_rgba(0,0,0,0.55)]">
            <div className="rounded-2xl bg-[#0b0b0b]/95 backdrop-blur-xl border border-white/[0.07] overflow-hidden flex flex-col max-h-[min(55vh,22rem)] lg:max-h-[calc(100vh-5.5rem)]">
              <div className="px-4 pt-4 pb-3 border-b border-white/10 bg-gradient-to-br from-primary/[0.12] via-transparent to-accent/[0.06] shrink-0">
                <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-primary/90 mb-2">Nexus</p>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-black/40 border border-white/10 text-primary shadow-inner shadow-black/40">
                ...
                {tagsLoading && (
                  <p className="text-[10px] text-text-muted/80 mt-2 font-medium">Syncing tags…</p>
                )}
              </div>
